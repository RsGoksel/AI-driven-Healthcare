...
CONTEXT_FILES = [
    ...
    ("Sempozyum Abstract A (Forward / FNO)",  "reports/abstract_a_en.md"),
    ("Sempozyum Abstract A — Türkçe",         "reports/abstract_a_tr.md"),
    ("Sempozyum Abstract B (Inverse / 3-DOF)", "reports/abstract_b_en.md"),
    ("Sempozyum Abstract B — Türkçe",         "reports/abstract_b_tr.md"),
...
SUGGESTED_QUESTIONS = [
    ...
    "Sempozyuma neden iki ayrı abstract (A ve B) gönderiyoruz, ne fark var?",
    "Kol A için FNO, U-Net'ten neden 2.7× daha iyi?",
    "FNO'nun k-Wave'e göre 7500× hızlanması ne kadar pratik kazanım?",
